========================================================================
    СТАТИЧЕСКАЯ БИБЛИОТЕКА. Обзор проекта Serial
========================================================================

Этот проект библиотеки Serial создан автоматически с помощью 
мастера приложений.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем Serial.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
